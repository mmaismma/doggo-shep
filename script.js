...
function success(pos) {
  ...
  p.textContent = 'Lat: ' + position.latitude + ', Long: ' + position.longitude + ' -- ' + Math.hypot((target.latitude - position.latitude), (target.longitude - position.longitude)).toPrecision(6);
